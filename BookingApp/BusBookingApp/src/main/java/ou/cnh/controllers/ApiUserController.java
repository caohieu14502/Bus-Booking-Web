...
public class ApiUserController {
    ...
    @CrossOrigin
    public ResponseEntity<User> details(Principal user, @RequestHeader(value = "Authorization") String token) throws IOException, GeneralSecurityException {
        ...
        if (u == null) {
            ...
            u = this.userService.getUserByMail(payload.getEmail());
